...
p.add_argument('-v', '--joint_call_vcf',metavar='FILE', help='Final single vcf output file if choose joint call')
...
def gatk_mvcf(pjobs, vcfout):
    ...
    job.memory = "6G"
    job.output = os.path.join(outdir, vcfout)
